...
public class MergeResult {
     ...
     *
     * @param mergedWriterFileSet map of data formats to merged writer file sets
     * @param rowIdMappings the row ID mappings produced during the merge, keyed by generation
     */
    ...
    /**
     * Gets the row ID mappings keyed by generation.
     *
     * @return the row ID mappings, or empty optional if none
     */
